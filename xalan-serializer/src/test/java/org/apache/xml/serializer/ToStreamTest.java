...
public class ToStreamTest {
    ...
    private final char HIGH = 55349;
    private final char LOW = 57109;
    private final String ESCAPED_DECIMAL_CODEPOINT = "&#120597;";
    ...
    public void testCharacters() {
        try {
            ...
            mock.flushPending();
            assertEquals("Output matched", "ab"+ESCAPED_DECIMAL_CODEPOINT+"c", mock_writer.getOutput());
    ...
    public void testCharactersSplitSurrogates() {
        try {
            ...
            mock.flushPending();
            assertEquals("Output matched", ESCAPED_DECIMAL_CODEPOINT, mock_writer.getOutput());
        }
        catch (SAXException e) {
            fail(e.getMessage());
        }
    ...
    private class MockStream extends ToStream {
        public MockStream() {
            ...
            m_encodingInfo = Encodings.getEncodingInfo("ASCII");
            setEscaping(true);
        }
